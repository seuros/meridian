...
enum {
	...
	kHFSPlusMountVersion = 0x31302E30,   /* '10.0' for Mac OS */
	kHFSJMountVersion    = 0x4846534a,   /* 'HFSJ' for journaled HFS+ on Mac OS */
...
/*
 * Mac OS has two special directories on HFS+ volumes for hardlinked files
 ...
 *
 * Note: Earlier version of Mac OS used a 32 bit random number for the link
...
/* Mac OS has 16 bytes worth of "BSD" info.
 *
...
enum {
	...
	kHFSAttributeDataFileID    = 13, /* Used in Mac OS runtime for extent based attributes */
